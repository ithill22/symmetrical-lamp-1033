def test_data
  ...
  @item_1 = @supermarket_1.create!(name: 'Bananas', price: 1)
  @item_2 = @supermarket_1.create!(name: 'Apples', price: 2)
  @item_3 = @supermarket_2.create!(name: 'Oranges', price: 3)
  @item_4 = @supermarket_2.create!(name: 'Pears', price: 4)
