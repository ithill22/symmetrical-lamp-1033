def test_data
  ...
  @supermarket_2 = Supermarket.create!(name: 'King Soopers', location: 'Louisville')
  @item_1 = @supermarket_1.items.create!(name: 'Bananas', price: 1)
  @item_2 = @supermarket_1.items.create!(name: 'Apples', price: 2)
  @item_3 = @supermarket_2.items.create!(name: 'Oranges', price: 3)
  @item_4 = @supermarket_2.items.create!(name: 'Pears', price: 4)
  @customer_1 = Customer.create!(name: 'Bob')
  @customer_2 = Customer.create!(name: 'Sally')
  @customer_3 = Customer.create!(name: 'Joe')
  @customer_4 = Customer.create!(name: 'Sue')
  ...
  CustomerItem.create!(customer_id: @customer_4.id, item_id: @item_3.id)
end
